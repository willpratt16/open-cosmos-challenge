...
* IERS Earth orientation parameters from 1973 to January 2026
...
* Marshall Solar Activity Future Estimation from 1999 to January 2026,
* CSSI Space Weather Data with observed data from 1957 to January 2026
  with predicted data up to 22 years in the future
* Space environment data (for Jacchia-Bowman 2008 model) from 1997 to end 2025
